...
const products = {
    beauty: { name: "Electric Facial Cleansing Brush", cost: 4.25, price: 24.99, trend: "trending", platform: "Amazon", buy_url: "https://www.amazon.com/s?k=electric+facial+cleansing+brush", image_url: "images/cleansing_brush.png", plan: "1. Brand as luxury item. 2. Launch TikTok ads. 3. Bundle with face wash for higher AOV." },
    fitness: { name: "Portable Pilates Bar Kit", cost: 11.50, price: 39.99, trend: "trending", platform: "Shopee", buy_url: "https://shopee.com/search?keyword=pilates+bar+kit", image_url: "images/pilates_bar.png", plan: "1. Target home-workouts. 2. Daily reels for social proof. 3. Upsell with a digital 30-day guide." },
    home: { name: "Magnetic Motion Sensor Lights", cost: 3.20, price: 19.95, trend: "stable", platform: "Lazada", buy_url: "https://www.lazada.com.ph/tag/magnetic-sensor-light/", image_url: "images/sensor_lights.png", plan: "1. Marketing: 'Smart home in 5s'. 2. Sell in multi-packs for volume. 3. Pinterest ads for styling." },
    tech: { name: "Foldable 3-in-1 Wireless Charger", cost: 13.80, price: 49.00, trend: "trending", platform: "Amazon", buy_url: "https://www.amazon.com/s?k=3+in+1+wireless+charger+foldable", image_url: "images/wireless_charger.png", plan: "1. Target digital nomads & techies. 2. High-quality unboxing content. 3. Google Search ads for travel." },
    pets: { name: "Self-Cleaning Slicker Brush", cost: 2.10, price: 18.50, trend: "stable", platform: "Shopee", buy_url: "https://shopee.com/search?keyword=self+cleaning+pet+brush", image_url: "images/pet_brush.png", plan: "1. Highlight 'One-Click' utility. 2. Partner with pet influencers. 3. Facebook ads for cat/dog owners." },
    kids: { name: "Reusable Water Coloring Book", cost: 1.50, price: 14.99, trend: "stable", platform: "Lazada", buy_url: "https://www.lazada.com.ph/tag/water-coloring-book/", image_url: "images/coloring_book.png", plan: "1. Focus on 'Mess-Free' travel. 2. Amazon PPC for travel games. 3. Target parents of toddlers." },
    food: { name: "Portable Electric Milk Frother", cost: 2.50, price: 15.00, trend: "saturated", platform: "Other", buy_url: "https://www.google.com/search?q=electric+milk+frother&tbm=shop", image_url: "images/milk_frother.png", plan: "1. Appeal to 'Coffee at Home'. 2. Create latte-art shorts. 3. Kitchen gadget bundles and gifting." }
};
